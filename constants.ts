...
export const mockUsers: User[] = [
    ...
    ], pendingFollowerIds: ['user-04'], savedStickers: ['/stickers/sticker1.png', '/stickers/sticker4.png'], bankAccount: { accountName: 'Alice W.', accountNumber: '1234567890', bankName: 'First Community Bank' } },
    ...
    { id: 'user-06', username: 'bob', password: 'password', role: 'Member', name: 'Bob', avatarUrl: 'https://i.pravatar.cc/150?u=bob', email: 'bob@example.com', address: '', city: '', zipCode: '', followingIds: ['user-02'], blockedUserIds: [], isActive: true, banExpiresAt: null, banReason: null, banStartDate: null, isVerified: true, reviews: [], pendingFollowerIds: [], savedStickers: [] },
