          ...
          case 'Topics':
              return userTopics.length > 0 ? (
                  <div className="space-y-4">
                      {userTopics.map(post => <PostListItem key={post.id} post={post} isSold={post.isSold} users={users} currentUser={currentUser} categoryName="" onSelect={() => onSelectPost(post)} onViewProfile={onViewProfile} onLike={onLike} onDislike={onDislike} onTogglePinPost={onTogglePinPost} onFlagPost={onFlagPost} />)}
                  </div>
              ...
              return userAdverts.length > 0 ? (
                  <div className="space-y-4">
                      {userAdverts.map(post => (
                          <PostListItem key={post.id} post={post} isSold={post.isSold} users={users} currentUser={currentUser} categoryName="" onSelect={() => onSelectPost(post)} onViewProfile={onViewProfile} onLike={onLike} onDislike={onDislike} onTogglePinPost={onTogglePinPost} onFlagPost={onFlagPost} />
                      ))}
                  </div>
