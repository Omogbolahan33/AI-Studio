...
import { HandThumbUpIcon, HandThumbDownIcon, UserCircleIcon, PencilIcon, TrashIcon, ArrowUpTrayIcon, PinIcon, FlagIcon, ShieldCheckIcon, LockClosedIcon, LockOpenIcon, CurrencyDollarIcon } from '../types';
            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        {(isAuthor || isAdmin) && (
                            <>
                                {isAuthor && post.isAdvert && (
                                     <button onClick={() => onToggleSoldStatus(post.id)} title={post.isSold ? "Mark as Available" : "Mark as Sold"} className={`p-2 rounded-full transition-colors ${post.isSold ? 'bg-gray-100 text-gray-600 hover:bg-gray-200' : 'bg-green-100 text-green-600 hover:bg-green-200'}`}>
